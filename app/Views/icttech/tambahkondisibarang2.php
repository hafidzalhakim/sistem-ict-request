...
<head>
    ...
    <title>Tambah Kondisi-ICT Tech</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Tambah Kondisi Barang-ICT Tech</sup></div>
            </a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Tambah Kondisi Barang</h1>
                    <div class="card shadow mb-4">
                        
                        <div class="card-body">
                            <form action="<?php echo site_url('prosestambahkbarangict') ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="kondisi" style="border-bottom: 3px solid #000;">Kondisi Barang</label><br>
                                ...
                                <div class="form-group">
                                <a href="<?=base_url('pengelola-kondisi-barang')?>" class="btn btn-danger" style="float: right; margin-right:10px">Cancel</a>
                                </div>
                            </form>
                    </div>
                    </div>
