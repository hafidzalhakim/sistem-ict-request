...
<head>
    ...
    <title>ICT Request-Tambah Request</title>
          ...
          <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('prosestambahrequest-admin-tech') ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="date_request" style="border-bottom: 3px solid #000;">Tanggal Request</label><br>
                                    <input type="date" name="date_request" id="date_request" class="form-control" value="<?php date_default_timezone_set("Asia/Jakarta"); echo date('Y-m-d')?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="time" style="border-bottom: 3px solid #000;">Waktu Request</label><br>
                                ...
                                <div class="form-group">
                                    <label for="id_jpermintaan" style="border-bottom: 3px solid #000;">Jenis Permintaan</label> <br>
                                    <select name="id_jpermintaan" id="id_jpermintaan" class="form-control">
                                        <option value="" selected disabled>--Option--</option>
                                        <?php foreach ($jenispermintaan as $key => $value) { ?>
                                          <option value="<?= $value['id_jpermintaan']?>"><?=$value['jpermintaan']?></option>
                                        <?php } ?>
                                ...
                                <div class="form-group">
                                    <label for="divisi" style="border-bottom: 3px solid #000;">Deskripsi</label><br>
                                ...
                                <div class="form-group">
                                <a href="<?=base_url('ict-request-admin')?>" class="btn btn-danger" style="float: right; margin-right:10px">Cancel</a>
                                </div>
                            </form>
                    </div>
                    </div>
