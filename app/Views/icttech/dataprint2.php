...
<head>
    ...
    <title>ICT Request-Report-ICT Tech</title>
          ...
          <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <input style="float: right;" type="button" value="Print PDF"
                        onclick="window.open('<?php echo site_url('printrequassigne/'.$rrinci->id_request) ?>','blank')">
                    <h1 class="h3 mb-4 text-gray-800">Data Print</h1>
