                  ...
                  >
                    ...
                    <?php foreach($datuba as $duse): ?>
                      <tr>
                        ...
                        <a href="<?php echo site_url('edit-barang-ict').'/'.$duse['id_barang']?>"><button class="btn btn-link" style="background-color: #FFBF00; color: black; margin-right:10px"><i class="fas fa-edit"></i> Edit</button></a>
                        <a href="<?php echo site_url('hapusdbict').'/'.$duse['id_barang']?>" onclick="alert('Apakah Anda Yakin Ingin Menghapus Data Ini?')"><button class="btn btn-danger"><i class="fas fa-trash"></i></button></a>
                        </td>
