    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Tambah Barang</sup></div>
            </a>
          ...
          <!-- End of Topbar -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="<?php echo site_url('prosestambahbarangict') ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="lokasi" id="lokasi" class="form-control">
                                        ...
                                        <?php foreach ($datulok as $key => $value) { ?>
                                          <option value="<?= $value['nama_lokasi']?>"><?=$value['nama_lokasi']?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                <a href="<?=base_url('pengelola-barang-ict')?>" class="btn btn-danger" style="float: right; margin-right:10px">Cancel</a>
                                </div>
                            </form>
                    </div>
                    </div>
