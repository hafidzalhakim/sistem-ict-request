        ...
        <div class="col-xl-10 col-lg-12 col-md-9">
          <div class="card o-hidden border-0 shadow-lg my-5">
            <div class="card-body p-0">
              ...
              <div class="row" style="background-color: #adff00;">
                <div class="col-lg-6 d-none d-lg-block" style="margin-top: 10%; ">
                  <img src=<?=base_url('assets/image/emp.png')?> alt="gambar emp" />
                </div>
                <div class="col-lg-6">
                  <div class="p-5">
                    ...
                    <?php
                        ...
                        if ($session->getFlashdata('error') == 'failed') {
                         echo "<div class='alert alert-danger font-weight-bold text-center'>
                             ...
                             echo "<div class='alert alert-danger font-weight-bold text-center'>
                                     tolong masukkan username atau password dengan benar
                                     </div>";
                        }
                    ?>
