...
<html lang="en">
  <head>
    ...
    <title>ICT Request-Area Manager</title>
    ...
    <div id="wrapper">
       ...
       <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a href=<?=base_url('/manager')?> class="sidebar-brand d-flex align-items-center justify-content-center" >
            ...
            <div class="sidebar-brand-text mx-3">ICT Request Approval</sup></div>
        </a>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  ...
                  >
                    ...
                    <tbody>
                    <?php foreach($rdata as $reque): ?>
                      <tr>
                        <td><?= $reque->nama_pengguna?></td>
                        <td><?= $reque->divisi?></td>
                        <td><?= $reque->time?></td>
