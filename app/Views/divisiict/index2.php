  ...
  <body id="page-top">
    ...
    <div id="wrapper">
       ...
       <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= site_url('divisi-ict') ?>">
            <div class="sidebar-brand-icon">
            <i class="fas fa-list-ul text-dark"></i>
            </div>
            <div class="sidebar-brand-text mx-3 text-white">Divisi ICT Request</div>
        </a>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              ...
              <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Request Belum Selesai</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $totalBelumSelesai ?></div>
                    </div>
                    <div class="col-auto">
        ...
        <footer class="sticky-footer bg-white">
          <div class="container my-auto">
            <div class="copyright text-center my-auto">
              <span>Copyright &copy; ICT Request <?= date("Y") ?></span>
            </div>
          </div>
        </footer>
        <!-- End of Footer -->
    ...
    <!-- Page level custom scripts -->    <script src=<?=base_url('assets/js/demo/datatables-demo.js')?>></script>
